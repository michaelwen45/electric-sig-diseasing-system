...
class ACLMigrationCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'make:migration:acl';
    ...
    {
        return base_path() . '/database/migrations/ACL/' . date('Y_m_d_His') . '_' . $name . '.php';
    }
    ...
    {
        $stub = $this->files->get(base_path().'/REM/migration_stubs/acl.stub');
