...
class CommandMigrationCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'make:migration:command';
     ...
     * @var string
     */
    protected $description = 'Create a new acl migration class';
    ...
    {
        return base_path() . '/database/command_migrations/' . date('Y_m_d_His') . '_' . $name . '.php';
    }
    ...
    {
        $stub = $this->files->get(base_path().'/REM/Migration_stubs/command.stub');
